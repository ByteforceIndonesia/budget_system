	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10">
				...
				<div class="alert alert-warning" style="margin-top: 0px!important;margin-bottom: 2px;"><i class="fa fa-exclamation-circle"></i>&nbsp;Jumlah Pembayaran Emas Bulan <?php echo $month ?>&nbsp;:&nbsp;<?php echo rupiah($trans_emas); ?></div>

				...
				<?php echo form_open('notes/edit/'.$note->id) ?>
					<table class="table">
						...
						<tr class="form-group">
							...
							<td>
								<input type="text" name="title" value="<?php echo $note->title ?>" class="form-control" placeholder="Judul">
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<textarea name="content" rows="10" placeholder="Isi Notes" class="form-control"><?php echo str_replace($breaks, "", $note->content) ?></textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2">
